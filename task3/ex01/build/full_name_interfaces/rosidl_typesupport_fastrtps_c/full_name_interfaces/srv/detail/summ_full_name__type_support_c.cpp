...
#include "full_name_interfaces/srv/detail/summ_full_name__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // name, patronymic, surname
#include "rosidl_runtime_c/string_functions.h"  // name, patronymic, surname

// forward declare type support functions


using _SummFullName_Request__ros_msg_type = full_name_interfaces__srv__SummFullName_Request;
...
size_t get_serialized_size_full_name_interfaces__srv__SummFullName_Request(
  const void * untyped_ros_message,
...
static uint32_t _SummFullName_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_full_name_interfaces__srv__SummFullName_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_full_name_interfaces
size_t max_serialized_size_full_name_interfaces__srv__SummFullName_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = full_name_interfaces__srv__SummFullName_Request;
    is_plain =
      (
...
static size_t _SummFullName_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_full_name_interfaces__srv__SummFullName_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, full_name_interfaces, srv, SummFullName_Request)() {
...
using _SummFullName_Response__ros_msg_type = full_name_interfaces__srv__SummFullName_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_full_name_interfaces
size_t get_serialized_size_full_name_interfaces__srv__SummFullName_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SummFullName_Response__ros_msg_type * ros_message = static_cast<const _SummFullName_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_full_name_interfaces__srv__SummFullName_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_full_name_interfaces
size_t max_serialized_size_full_name_interfaces__srv__SummFullName_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = full_name_interfaces__srv__SummFullName_Response;
    is_plain =
      (
...
static size_t _SummFullName_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_full_name_interfaces__srv__SummFullName_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, full_name_interfaces, srv, SummFullName_Response)() {
...
// already included above
// #include "full_name_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "full_name_interfaces/srv/summ_full_name.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, full_name_interfaces, srv, SummFullName)() {
