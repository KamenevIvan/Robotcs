...
bool ex0402b__msg__current_target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ex0402b.msg._current_target.CurrentTarget", full_classname_dest, 41) == 0);
  }
  ex0402b__msg__CurrentTarget * ros_message = _ros_message;
  {  // target_name
...
{
  /* NOTE(esteve): Call constructor of CurrentTarget */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ex0402b.msg._current_target");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CurrentTarget");
