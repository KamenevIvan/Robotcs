...
{
  new (message_memory) ex0402b::msg::CurrentTarget(_init);
}

void CurrentTarget_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ex0402b::msg::CurrentTarget *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CurrentTarget_message_member_array[4] = {
  {
    ...
    offsetof(ex0402b::msg::CurrentTarget, target_name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ex0402b::msg::CurrentTarget, target_x),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ex0402b::msg::CurrentTarget, target_y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ex0402b::msg::CurrentTarget, distance_to_target),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CurrentTarget_message_members = {
  "ex0402b::msg",  // message namespace
  "CurrentTarget",  // message name
  4,  // number of fields
  sizeof(ex0402b::msg::CurrentTarget),
...
{
  return &::ex0402b::msg::rosidl_typesupport_introspection_cpp::CurrentTarget_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ex0402b, msg, CurrentTarget)() {
  return &::ex0402b::msg::rosidl_typesupport_introspection_cpp::CurrentTarget_message_type_support_handle;
}
