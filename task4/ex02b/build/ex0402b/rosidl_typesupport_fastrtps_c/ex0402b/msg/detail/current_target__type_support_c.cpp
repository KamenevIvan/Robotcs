...
#include "ex0402b/msg/detail/current_target__rosidl_typesupport_fastrtps_c.h"
...
#include "ex0402b/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _CurrentTarget__ros_msg_type = ex0402b__msg__CurrentTarget;
  ...
  void * untyped_ros_message)
{
  ...
  _CurrentTarget__ros_msg_type * ros_message = static_cast<_CurrentTarget__ros_msg_type *>(untyped_ros_message);
  // Field name: target_name
  {
    std::string tmp;
    cdr >> tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ex0402b
size_t get_serialized_size_ex0402b__msg__CurrentTarget(
  const void * untyped_ros_message,
...
static uint32_t _CurrentTarget__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ex0402b__msg__CurrentTarget(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ex0402b
size_t max_serialized_size_ex0402b__msg__CurrentTarget(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ex0402b__msg__CurrentTarget;
    is_plain =
      (
...
static size_t _CurrentTarget__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ex0402b__msg__CurrentTarget(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ex0402b, msg, CurrentTarget)() {
